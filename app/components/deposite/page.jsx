...
import QR from "../../../public/assets/images/icons/scan.svg";
import depositearrow from "../../../public/assets/images/icons/depositearrow.svg";
        ...
        <div className="gittu-modal-content">
          ...
          <div className="flex justify-center items-center  gap-2">
            ...
            <div className="mx-2">
              <button
                onClick={notify}
                className="rounded-circle border rounded-full"
              >
